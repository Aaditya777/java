...
public class StackBrick extends  TetrisBrick{
    ...
    public void rotate() {
        ...
        {
            super.getPosition()[0][0] += 1;
            super.getPosition()[1][0] += 1;
//        super.getPosition()[2][0] += 1;
            super.getPosition()[3][0] -= 1;

            super.getPosition()[0][1] += 1;
            super.getPosition()[1][1] -= 1;
//          super.getPosition()[2][1] += 1;
            super.getPosition()[3][1] += 1;
